...
const routes: Routes = [
  ...
  {path: 'createAssessorName/:id', component:CreateAccessorNameComponent},
  {path: 'stageOfWork', component:StageOfWorkComponent},
  {path: 'createStageOfWork/:id', component:CreateStageOfWorkComponent},
  ...
  {path: 'createActivityNotAvailableDuringInspection/:id', component:CreateInspectionActivityComponent},
  ...
  {path: 'remarks', component:RemarkComponent},
  {path: 'createRemark/:id', component:CreateRemarkComponent},
